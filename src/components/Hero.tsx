...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden px-4 pb-16 pt-8 desktop:px-10 desktop:pb-24 desktop:pt-12">
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-10 desktop:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6 text-center desktop:text-left">
            ...
            <div className="space-y-4">
              <h1 className="font-serif text-5xl leading-tight text-ink desktop:text-7xl">
                {invitation.event.title}
              </h1>
              <div className="flex flex-wrap items-end justify-center gap-x-8 gap-y-3 text-[#7a2234] desktop:justify-start">
                <div className="space-y-0">
                  <p className="text-2xl tracking-[0.18em] desktop:text-3xl">{invitation.couple.groom}</p>
                  <p className="-mt-2 text-base tracking-[0.32em] text-ink/50">{invitation.hero.roleLabels.groom}</p>
                </div>
                <div className="space-y-0">
                  <p className="text-2xl tracking-[0.18em] desktop:text-3xl">{invitation.couple.bride}</p>
            ...
            <div className="flex flex-col items-center gap-3 desktop:flex-row desktop:justify-center desktop:items-start desktop:justify-start">
              <a
          ...
          <div className="relative">
            <div className="absolute -left-6 top-10 hidden h-48 w-48 rounded-full bg-[#dcb8b2]/80 blur-3xl desktop:block" />
            <div className="absolute -bottom-8 right-0 hidden h-52 w-52 rounded-full bg-[#b97a84]/35 blur-3xl desktop:block" />
            <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-[#fff8f3]/82 shadow-soft backdrop-blur">
              <div className="relative aspect-[4/5] overflow-hidden bg-[#ead4c9]">
                ...
                <div className="absolute inset-4 flex h-[calc(100%-2rem)] flex-col justify-between rounded-[1.35rem] border border-white/55 p-5 text-ink desktop:inset-6 desktop:h-[calc(100%-3rem)] desktop:p-6">
                  <div className="space-y-4 desktop:space-y-3">
                    <p className="text-base tracking-[0.32em] text-[#7a2234]/80 desktop:text-xl desktop:tracking-[0.35em]">
                      {invitation.hero.saveTheDateLabel}
                    </p>
                    <p className="font-serif text-[2.15rem] leading-[1.1] desktop:text-5xl desktop:leading-none">
                      {invitation.hero.saveTheDateDateText}
                    </p>
                    {invitation.hero.saveTheDateDayText ? (
                      <p className="text-base tracking-[0.22em] text-[#7a2234]/80 desktop:text-xl desktop:tracking-[0.25em]">
                        {invitation.hero.saveTheDateDayText}
                      </p>
                    ) : null}
                  </div>
                  <div className="mb-1 self-end text-right desktop:-mr-2 desktop:mb-3">
                    <p className="font-serif text-[2rem] tracking-[0.08em] text-[#412a24] drop-shadow-[0_1px_1px_rgba(255,248,243,0.45)] desktop:text-[2.6rem]">
